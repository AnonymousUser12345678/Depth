# python main.py --data kitti --student_arch resnet18 --loss kd --student_input_size 64
# python main.py --data kitti --student_arch resnet18 --loss kd --student_input_size 32
...
# python main.py --data kitti --student_arch resnet34 --loss kd --student_input_size 64
# python main.py --data kitti --student_arch resnet34 --loss kd --student_input_size 32
...
# p/ython main.py --data kitti --student_arch resnet18 --loss kd --student_input_size 64 --global_info --epochs 30
# /python main.py --data kitti --student_arch resnet18 --loss kd --student_input_size 32 --global_info --epochs 30
...
# python main.py --data kitti --student_arch resnet34 --loss kd --student_input_size 64 --global_info --epochs 30
# python main.py --data kitti --student_arch resnet34 --loss kd --student_input_size 32 --global_info --epochs 30



# python test.py --data kitti --loss mse --student_arch resnet18 --student_input 64 --global_info
# python test.py --data kitti --loss mse --student_arch resnet18 --student_input 32 --global_info
